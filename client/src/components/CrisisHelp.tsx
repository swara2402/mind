      ...
      <Card className="border-orange-200 dark:border-orange-800 bg-orange-50/50 dark:bg-orange-950/20">
        <CardHeader>
          <div className="flex items-center gap-3">
            <motion.div 
              className="w-10 h-10 bg-orange-100 dark:bg-orange-900 rounded-full flex items-center justify-center"
              {...(reduceMotion ? {} : {
        ...
        <CardContent className="space-y-6">
          <motion.div 
            className="text-sm text-orange-700 dark:text-orange-300 bg-orange-100/50 dark:bg-orange-900/50 p-4 rounded-lg"
          ...
          >
            ...
            >
              You're not alone. Professional counselors are ready to listen and help. Your life matters, and support is available.
            </motion.p>
          </motion.div>
