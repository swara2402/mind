...
export default function HeroSection({ onStartChat }: { onStartChat: () => void }) {
  return (
    <motion.section 
      id="hero-section"
      className="relative min-h-screen flex items-center bg-gradient-to-br from-primary/20 to-accent/30 overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12 bg-white/20 backdrop-blur-md rounded-lg">
        <motion.div 
