...
function InnerMoodTracker({ userId }: MoodTrackerProps) {
  ...
  // Load mood history on component mount only if user is authenticated
  useEffect(() => {
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium mb-2">Sign in to track your mood</h3>
              <p className="text-muted-foreground mb-4">
                Create an account to start tracking your mood patterns and get personalized insights.
              </p>
              <Button>
