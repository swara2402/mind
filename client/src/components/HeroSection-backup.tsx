      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        ...
        >
          <div className="space-y-4">
            <motion.h1
              className="text-4xl md:text-6xl font-medium text-white drop-shadow-lg"
              initial={{ opacity: 0, y: 0 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            >
              <Button
                size="lg"
                className="px-8 py-6 text-lg bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg"
                onClick={onStartChat}
            ...
            >
              <Button
                variant="outline"
                size="lg"
                className="px-8 py-6 text-lg bg-white/10 backdrop-blur-sm border-white/20 text-white hover:bg-white/20 shadow-lg"
